...
esp_mqtt_client_handle_t client_ble;
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        ...
        .credentials.username = "FUpYAljraBU3Bz3k2rtEHKcYJj8WNkggfJk6RBGhO9OyeqQWwFwKsV7nZki2a6S1",
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                ESP_LOGI(EXAMPLE_TAG, "X: %s \n", (char *) param->write.value);
                int msg_id;
                esp_mqtt_client_publish(client_ble, "/topic/qos0", (char *) param->write.value, 0, 0, 0);
